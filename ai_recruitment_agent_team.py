...
def extract_text_from_pdf(pdf_file) -> str:
    """Extract text from a PDF file and handle errors gracefully."""
    try:
        ...
        st.error(f"Error extracting PDF text: {str(e)}. Please ensure the PDF is not corrupted and is in a supported format.")
        return ""


def analyze_resume(
    resume_text: str,
    role: Literal["ai_ml_engineer", "frontend_engineer", "backend_engineer", "data_scientist"],
    analyzer: Agent
) -> Tuple[bool, str]:
    try:
